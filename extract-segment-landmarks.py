...
if __name__ == "__main__":
    ...
    accepted_segments_path = join(
        __data_root, "df", "segments", inspect_label, "accepted.npy"
    )
    ...
    evaluated_segments = glob(
        join(__data_root, "df", "segments", inspect_label, "*.pkl"), recursive=True
    )
    ...
    for segment_path in segments:
        ...
        if response == "y":
            accepted_segments.add(segment_path)
